...
export default function WinScreen(props) {
    ...
    return (
        <div className="gamescreen-overlay z-10 absolute bg-[rgba(0,0,0,0.15)] w-screen h-[90%] flex items-center justify-center">
            <div className="gamescreen-container grid items-center bg-primary-900 w-fit h-fit rounded-xl p-8 text-primary-50">
                <h1 className="text-4xl text-center">You Won!</h1>
                <p className="text-center">{winMsg} </p>
                <button className='border-2 px-4 py-2 rounded-lg border-secondary-900 text-secondary-900 bg-primary-200'
